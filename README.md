...
| 레포 | 내용 |
|---|---|
| [minipg](https://github.com/wz0405/minipg) | 미니 PG 결제·정산 파이프라인 — 6개 결제수단 승인부터 원가/판가 수수료, 일정산·지급 배치, 망취소까지. 제휴사 어댑터로 확장하는 프로세스 템플릿 구조 ([라이브 데모](https://gks0405.synology.me:8090), 운영 중) |
